...
class MainWindow(QMainWindow):
    ...
    def _on_setup_done(self, key: str, os_name: str):
        ...
        # Read-modify-write: a fresh overwrite here would wipe out any config
        # already present (assistant/user name, voice, wake word, ...) written
        # before the API key was entered.
        data: dict = {}
        if API_FILE.exists():
            try:
